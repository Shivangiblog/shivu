...
const HostelCard = ({ hostel }: { hostel: Hostel }) => {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      await axios.put(
        "https://hostelbackend-tzrj.onrender.com/api/admin/hostels/verify",
        { hostelId: hostel._id },
        {
          headers: {
  ...
  const handleRemove = async () => {
    ...
    try {
      ...
      await axios.delete(
        `https://hostelbackend-tzrj.onrender.com/api/admin/hostels/${hostel._id}`,
        {
          headers: {
            Authorization: ` Bearer ${token}`,
          },
  ...
  const handleEdit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.put("https://hostelbackend-tzrj.onrender.com/api/admin/hostels", updateData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
    ...
    const fetchHostels = async () => {
      ...
      try {
        const hostelResponse = await axios.get(
          "https://hostelbackend-tzrj.onrender.com/api/admin/hostels",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
