...
const fetchOwnerData = async (profileId: string) => {
  try {
    const response = await fetch(
      `https://hostelbackend-tzrj.onrender.com/api/hostels/owners/${profileId}`,
      {
        headers: {
...
const HostelOwnerDashboard: React.FC = () => {
  ...
  const handleRequestOTP = async (
    ...
    try {
      await axios.post(
        "https://hostelbackend-tzrj.onrender.com/api/auth/forgot-password",
  ...
  const handleVerifyOTPAndChangePassword = async (token: string) => {
    ...
    try {
      await axios.post(
        "https://hostelbackend-tzrj.onrender.com/api/auth/reset-password",
        {
          email: profileData.email,
          otp,
          newPassword,
  ...
  const handleProfileSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `https://hostelbackend-tzrj.onrender.com/api/hostels/owner/${profileId}`,
        {
          method: "PUT",
          headers: {
  ...
  const logoutUser = async () => {
    ...
    try {
      ...
      await axios.post(
        "https://hostelbackend-tzrj.onrender.com/api/auth/logout",
        {},
        config
      );
    } catch (error) {
