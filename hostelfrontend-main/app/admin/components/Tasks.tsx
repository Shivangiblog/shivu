...
const TaskList: React.FC = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const [studentResponse, hostelResponse] = await Promise.all([
          axios.get(
            "https://hostelbackend-tzrj.onrender.com/api/admin/students",
            {
  ...
  const handleRemoveItem = async (taskId: string, itemIndex: number) => {
    ...
    try {
      ...
      await axios.post(
        "https://hostelbackend-tzrj.onrender.com/api/admin/wishlist/remove",
  ...
  const handleApproveTask = async (taskId: string) => {
    try {
      ...
      await axios.post(
        "https://hostelbackend-tzrj.onrender.com/api/admin/approve-wishlist",
        { studentId: taskId },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
